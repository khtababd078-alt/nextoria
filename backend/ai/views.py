...
قواعد اللغة — أعلى أولوية، لا استثناء أبداً:
- CRITICAL: اكتب بالعربية فقط في كل ردودك بدون أي استثناء.
- أي حرف من أي لغة أخرى ممنوع تماماً: لا إنجليزية، لا صينية، لا فارسية، لا تايلاندية، لا يابانية، لا كورية، لا أي لغة أخرى غير العربية.
- إذا كانت المعلومات من قاعدة البيانات بالإنجليزية، ترجمها للعربية أولاً ثم اكتبها.
